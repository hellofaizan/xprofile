      ...
      <div className=" w-full h-auto overflow-hidden border border-gray-700 hover:border-gray-600 hover:scale-[1.006] rounded-xl">
        <div className="bg-[#080808] rounded-lg shadow-lg">
          ...
          <div className='flex flex-col'>
            ...
            <p className='mx-4 md:mx-5 text-base truncate md:min-h-[48px] line-clamp-none md:line-clamp-3'>{aboutWithoutLink} <Link href={aboutLink} target="_blank" rel="noopener noreferrer" className='text-blue-400 hover:text-blue-500 cursor-pointer'>{aboutLink}</Link></p>
      ...
      <div className=" w-full h-auto overflow-hidden border border-gray-700 hover:border-gray-600 hover:scale-[1.006] rounded-xl">
        <div className="bg-[#080808] rounded-lg shadow-lg">
          ...
          <div className='flex flex-col'>
            ...
            <div className='mx-4 md:mx-5 text-base lg:min-h-[48px] truncate line-clamp-none md:line-clamp-3'>{props.about}</div>
