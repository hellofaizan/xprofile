    ...
    <motion.div
      ...
      <div class="grid h-screen px-4 place-content-center">
        <div class="text-center">
          ...
          <p class="mt-4 text-gray-400">Error loading data to screen.</p>
              ...
              <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div class="block sm:hidden">
                    ...
                    <Link href={"https://github.com/hellofaizan/xprofile"} class="p-3 ml-2 text-sm font-medium text-white bg-gray-700 rounded-lg focus:ring-4 focus:outline-none hover:bg-gray-600 focus:ring-gray-500">
                      ⭐
