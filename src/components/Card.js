      ...
      <div className=" w-full h-auto overflow-hidden border border-gray-700 hover:border-gray-600 hover:scale-[1.006] rounded-xl">
        <div className="bg-[#080808] rounded-lg shadow-lg">
          <div className="flex flex-col">
            ...
            <div className="flex space-x-2">
              ...
              <div className="flex items-baseline gap-1">
                ...
                <Link
                  ...
                  className="mt-2 font-mono italic text-gray-300 text-sm hover:text-blue-400 cursor-pointer"
                >
                  @{props.username}
                </Link>
              </div>
            ...
            {aboutLink ? (
              <p className="mx-4 md:mx-5 text-base overflow-hidden text-ellipsis min-h-[48px] line-clamp-none md:line-clamp-2">
                {aboutWithoutLink}{" "}
                <Link
                  href={aboutLink}
                  target="_blank"
              ...
              <div className="mx-4 md:mx-5 text-base overflow-hidden min-h-[48px] text-ellipsis line-clamp-none md:line-clamp-2 md:hover:line-climp-3">
                {props.about}
              </div>
            )}
            ...
            <div className="flex flex-col gap-2 text-center md:flex-row justify-between mt-2 mb-4 mx-4 md:mx-5">
              ...
              >
                Follow on Github <i className="bi bi-github"></i>
              </Link>
              <Link
                href={"https://twitter.com/" + props.username}
                target="_blank"
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-gray-700 rounded hover:bg-gray-600 focus:outline-none focus:ring"
              >
                Follow on Twitter <i className="bi bi-twitter"></i>
              </Link>
            </div>
          </div>
        </div>
