      ...
      <div className=" w-full h-auto overflow-hidden border border-gray-700 hover:border-gray-600 hover:scale-[1.006] rounded-xl">
        <div className="bg-[#080808] rounded-lg shadow-lg">
          ...
          <div className='flex flex-col'>
            ...
            <div className='mx-4 md:mx-5 text-base'>{props.about}</div>

            {/* Follow on github and on twitter button 2 in column */}
            <div className='flex flex-col gap-2 text-center md:flex-row justify-between mt-2 mb-2 mx-4 md:mx-5'>
              <Link href={"https://githib.com/" + props.github} target="_blank" rel="noopener noreferrer" className='px-4 py-2 text-sm font-medium text-white bg-gray-700 rounded hover:bg-gray-600 focus:outline-none focus:ring'>Follow on Github <i className='bi bi-github'></i></Link>
              <Link href={"https://twitter.com/" + props.username} target="_blank" rel="noopener noreferrer" className='px-4 py-2 text-sm font-medium text-white bg-gray-700 rounded hover:bg-gray-600 focus:outline-none focus:ring'>Follow on 𝕏 <i className='bi bi-twitter'></i></Link>
            </div>
